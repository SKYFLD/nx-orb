...
RESPONSE=$(node index.js $CIRCLE_ORGANIZATION_ID $CIRCLE_PROJECT_ID $TARGET_BRANCH $PARAM_MAIN_BRANCH $PARAM_ERROR_ON_NO_SUCCESSFUL_WORKFLOW $PARAM_ALLOW_ON_HOLD $PARAM_SKIP_BRANCH_FILTER $PARAM_WORKFLOW_NAME $PARAM_TAG_REGEX)
echo "$RESPONSE"
